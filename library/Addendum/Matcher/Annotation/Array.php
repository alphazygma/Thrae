 ...
 * @version 0.4.1
 */
class Addendum_Matcher_Annotation_Array extends Addendum_Matcher_Parallel
{
    protected function build()
    {
        $this->add(new Addendum_Matcher_Constant('{}', array()));
        $valuesMatcher = new Addendum_Matcher_Serial_Simple(1);
        $valuesMatcher->add(new Addendum_Matcher_Regex('\s*{\s*'));
        $valuesMatcher->add(new Addendum_Matcher_Annotation_ArrayValues());
        $valuesMatcher->add(new Addendum_Matcher_Regex('\s*}\s*'));

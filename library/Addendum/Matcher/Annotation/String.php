 ...
 * @version 0.4.1
 */
class Addendum_Matcher_Annotation_String extends Addendum_Matcher_Parallel
{

    protected function build()
    {
        $this->add(new Addendum_Matcher_Annotation_String_SingleQuoted());
        $this->add(new Addendum_Matcher_Annotation_String_DoubleQuoted());
    }

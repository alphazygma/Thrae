 ...
 * @version 0.4.1
 */
class Addendum_Matcher_Annotation_Value extends Addendum_Matcher_Parallel
{
    protected function build()
    {
        $this->add(new Addendum_Matcher_Constant('true', true));
        $this->add(new Addendum_Matcher_Constant('false', false));
        $this->add(new Addendum_Matcher_Constant('TRUE', true));
        $this->add(new Addendum_Matcher_Constant('FALSE', false));
        $this->add(new Addendum_Matcher_Constant('NULL', null));
        $this->add(new Addendum_Matcher_Constant('null', null));
        $this->add(new Addendum_Matcher_Annotation_String());
        $this->add(new Addendum_Matcher_Annotation_Number());
        $this->add(new Addendum_Matcher_Annotation_Array());
        $this->add(new Addendum_Matcher_Annotation_StaticConstant());
        $this->add(new Addendum_Matcher_Annotation_Nested());
    }
}

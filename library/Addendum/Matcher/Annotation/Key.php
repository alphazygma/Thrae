 ...
 * @version 0.4.1
 */
class Addendum_Matcher_Annotation_Key extends Addendum_Matcher_Parallel
{
    protected function build()
    {
        $this->add(new Addendum_Matcher_Regex('[a-zA-Z][a-zA-Z0-9_]*'));
        $this->add(new Addendum_Matcher_Annotation_String());
        $this->add(new Addendum_Matcher_Annotation_Integer());
    }
}

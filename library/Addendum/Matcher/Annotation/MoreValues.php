 ...
 * @version 0.4.1
 */
class Addendum_Matcher_Annotation_MoreValues
    extends Addendum_Matcher_Serial_Simple
{
    protected function build()
    {
        $this->add(new Addendum_Matcher_Annotation_Array_Value());
        $this->add(new Addendum_Matcher_Regex('\s*,\s*'));
        $this->add(new Addendum_Matcher_Annotation_ArrayValues());
    }

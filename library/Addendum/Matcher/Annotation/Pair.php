 ...
 * @version 0.4.1
 */
class Addendum_Matcher_Annotation_Pair extends Addendum_Matcher_Serial
{
    protected function build()
    {
        $this->add(new Addendum_Matcher_Annotation_Key());
        $this->add(new Addendum_Matcher_Regex('\s*=\s*'));
        $this->add(new Addendum_Matcher_Annotation_Value());
    }

 ...
 * @version 0.4.1
 */
class Addendum_Matcher_Annotation extends Addendum_Matcher_Serial
{
    protected function build()
    {
        $this->add(new Addendum_Matcher_Regex('@'));
        $this->add(new Addendum_Matcher_Regex('[A-Z][a-zA-Z0-9_]*'));
        $this->add(new Addendum_Matcher_Annotation_Parameters());
    }
